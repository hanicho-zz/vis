    ...
    : QGLWidget(parent), _slider(0)
{
    ...
    _info._ready_to_init=false;
    _info._did_init=false;
...
//
//++++++++++++++++++++++
void glwidget::delayed_init(){

    //
    if( !_info._ready_to_init || _info._did_init )
        return;

    //
    _info._did_init=true;
...
void glwidget::paintGL() {
    ...
    //
    if( !_info._ready_to_draw || !_info._did_init )
        return;

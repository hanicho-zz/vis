...
void view_edit_search::write_attributes(){
...
void view_edit_search::write_categories(QListWidgetItem *item){
...
void view_edit_search::append_value_to_query(QListWidgetItem *item){
...
void view_edit_search::do_submit(){
    ...
    //
    _active_result->set_filter( filter );
